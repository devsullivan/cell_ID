function masterCellIdentification(infolder,outfolder)
...
if nargin<1
    infolder = '/Volumes/DevinsStorage/cell_ID/validation_upload/';%%%THIS IS AN EXAMPLE
end
...
if nargin<2 || isempty(outfolder)
    outfolder = './validation_upload2';%['/server/plate/'];
end
